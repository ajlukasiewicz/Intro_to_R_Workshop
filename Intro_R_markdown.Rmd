...
##Section 5. Tidying data example
...
## Section 6. Row/column addition (`mutate()`, `bind_rows()`, `left_join()`)
...
### Section 6.1 Adding a new column
...
### Section 6.2 Binding two experiments together
...
### Section 6.3 Joining an experiment table with an annotation table
...
## Section 7. Subsetting data (`filter()`, `select()`)
...
```{r 7.0 filtering and selecting}
# your R code here
```

## Section 8. Aggregating data (`group_by()`, `summarize()`, `arrange()`)
